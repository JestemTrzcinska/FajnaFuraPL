...
var register_send = /*#__PURE__*/function () {
  ...
  return function register_send(_x) {
    return _ref.apply(this, arguments);
  };
}();

var login_send = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            ...
            if (errors) {
              errors.forEach(function (error) {
                var field = document.getElementById('login_' + error.param);
                field.classList.add('error');
                field.parentElement.classList.add('error-msg2');
                field.parentElement.setAttribute('data-errormsg', error.msg);
              });
  ...
  return function login_send(_x2) {
