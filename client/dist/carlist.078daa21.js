...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"carlist.js":[function(require,module,exports) {
"use strict";
...
axios.get('http://localhost:5000/api/cars').then(function (response) {
  readcars(response.data);
}).catch(function (err) {
  console.log(err);
});

var readcars = function readcars(data) {
  data.forEach(function (car) {
    var newdiv = $("div#carbox.prototype").clone();
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","carlist.js"], null)
//# sourceMappingURL=/carlist.078daa21.js.map